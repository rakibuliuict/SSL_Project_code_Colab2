...
from pancreas.losses import DiceLoss  # Assuming this is your custom DiceLoss
...
parser.add_argument('--model', type=str, default='VNet', choices=['VNet'])
...
# from monai.losses import DiceFocalLoss  # ✅ NEW: MONAI loss
